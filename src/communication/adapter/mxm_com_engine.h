...
using EngineHandlerWorker =
    std::function<void(void (*handler)(MxmComMessageCtx &messageCtx), MxmComMessageCtx &messageCtx)>;
...
protected:
   ...
   */
    ...
    bool TlsPrivateKeyCallback(const std::string &name, std::string &path, void *&pw, int &length,
