...
static const std::unordered_map<uint32_t, std::string> errorStrMapping = {
    {MXM_OK, "MXM_OK"},
    {MXM_ERR_MEMLIB, "MXM_ERR_MEMLIB"},
    {MXM_ERR_NULLPTR, "MXM_ERR_NULLPTR"},
    {MXM_ERR_MALLOC_FAIL, "MXM_ERR_MALLOC_FAIL"},
    {MXM_ERR_MEMORY, "MXM_ERR_MEMORY"},
    {MXM_ERR_PARAM_INVALID, "MXM_ERR_PARAM_INVALID"},
    {MXM_ERR_MMAP_VA_FAILED, "MXM_ERR_MMAP_VA_FAILED"},
    {MXM_ERR_CHECK_RESOURCE, "MXM_ERR_CHECK_RESOURCE"},
    {MXM_ERR_DAEMON_NO_FEATURE_ENABLED, "MXM_ERR_DAEMON_NO_FEATURE_ENABLED"},
    {MXM_ERR_NAME_BUSY, "MXM_ERR_NAME_BUSY"},
    {MXM_ERR_IPC_INIT_CALL, "MXM_ERR_IPC_INIT_CALL"},
    {MXM_ERR_IPC_SYNC_CALL, "MXM_ERR_IPC_SYNC_CALL"},
    {MXM_ERR_IPC_HCOM_INNER_SYNC_CALL, "MXM_ERR_IPC_HCOM_INNER_SYNC_CALL"},
    {MXM_ERR_IPC_CRC_CHECK_ERROR, "MXM_ERR_IPC_CRC_CHECK_ERROR"},
    {MXM_ERR_IPC_SERIALIZE_DESERIALIZE_ERROR, "MXM_ERR_IPC_SERIALIZE_DESERIALIZE_ERROR"},
    {MXM_ERR_REGISTER_OP_CODE, "MXM_ERR_REGISTER_OP_CODE"},
    {MXM_ERR_REGISTER_HANDLER_NULL, "MXM_ERR_REGISTER_HANDLER_NULL"},
    {MXM_ERR_RPC_QUERY_ERROR, "MXM_ERR_RPC_QUERY_ERROR"},
    {MXM_ERR_LOCK_NOT_READY, "MXM_ERR_LOCK_NOT_READY"},
    {MXM_ERR_LOCK_ALREADY_LOCKED, "MXM_ERR_LOCK_ALREADY_LOCKED"},
    {MXM_ERR_LOCK_NOT_FOUND, "MXM_ERR_LOCK_NOT_FOUND"},
    {MXM_ERR_DLOCK_LIB, "MXM_ERR_DLOCK_LIB"},
    {MXM_ERR_DLOCK_INNER, "MXM_ERR_DLOCK_INNER"},
    {MXM_ERR_RECORD_DELETE, "MXM_ERR_RECORD_DELETE"},
    {MXM_ERR_RECORD_ADD, "MXM_ERR_RECORD_ADD"},
    {MXM_ERR_RECORD_CHANGE_STATE, "MXM_ERR_RECORD_CHANGE_STATE"},
    {MXM_ERR_REGION_NOT_FOUND, "MXM_ERR_REGION_NOT_FOUND"},
    {MXM_ERR_REGION_PARAM_INVALID, "MXM_ERR_REGION_PARAM_INVALID"},
    {MXM_ERR_REGION_EXIST, "MXM_ERR_REGION_EXIST"},
    {MXM_ERR_REGION_NOT_EXIST, "MXM_ERR_REGION_NOT_EXIST"},
    {MXM_ERR_REGION_NO_NEEDED, "MXM_ERR_REGION_NO_NEEDED"},
    {MXM_ERR_SHM_NOT_FOUND, "MXM_ERR_SHM_NOT_FOUND"},
    {MXM_ERR_SHM_ALREADY_EXIST, "MXM_ERR_SHM_ALREADY_EXIST"},
    {MXM_ERR_SHM_PERMISSION_DENIED, "MXM_ERR_SHM_PERMISSION_DENIED"},
    {MXM_ERR_SHM_IN_USING, "MXM_ERR_SHM_IN_USING"},
    {MXM_ERR_SHM_NOT_EXIST, "MXM_ERR_SHM_NOT_EXIST"},
    {MXM_ERR_LEASE_NOT_FOUND, "MXM_ERR_LEASE_NOT_FOUND"},
    {MXM_ERR_LEASE_NOT_EXIST, "MXM_ERR_LEASE_NOT_EXIST"},
    {MXM_ERR_UBSE_INNER, "MXM_ERR_UBSE_INNER"},
    {MXM_ERR_UBSE_LIB, "MXM_ERR_UBSE_LIB"},
    {MXM_ERR_UBSE_NOT_ATTACH, "MXM_ERR_UBSE_NOT_ATTACH"},
    {MXM_ERR_OBMM_INNER, "MXM_ERR_OBMM_INNER"},
    {MXM_ERR_SHM_OBMM_OPEN, "MXM_ERR_SHM_OBMM_OPEN"},
};
